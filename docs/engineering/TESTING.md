...
Current tests prove frontend and confirmed business-rule behavior against
deterministic mock scenarios. API and database behavior requires integration
tests in addition to this suite.
