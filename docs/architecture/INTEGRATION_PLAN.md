...
Define how the frontend built without database access will later connect to the existing production database without requiring a frontend rewrite.
...
The frontend feature components should remain substantially unchanged.
