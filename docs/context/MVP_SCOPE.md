...
The current development target is a modular web MVP with a Node integration
backend and deterministic mock mode.
...
# 2. Explicitly not yet production-ready

- production database connection
- production identity provider
- production authorization rollout
...
- unapproved database redesign or migrations
- schema redesign
...
9. Mock repositories and HTTP repositories implement the same contracts.
