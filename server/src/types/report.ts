...
export type OkBacklogReport = { ok: true; rows: BacklogReportRow[] }
export type YearlyBacklogReportRow = { ano: number | null; backlogStart: number; nob: number; revenue: number; backlogEnd: number }
export type OkYearlyBacklogReport = { ok: true; rows: YearlyBacklogReportRow[] }
