...
/**
 * Full-screen BRUKER splash shown on every app startup. Plays an intro video while
...
export function IntroSplash({
  videoSrc = '/BRUKER_logo_startup_animation_202608260850.mp4',
}: {
  videoSrc?: string
}) {
