...
export function DatePicker({
  ...
  useEffect(() => {
    // This effect intentionally mirrors external controlled state into the edit buffer.
  ...
  function handlePointerDown(event: React.PointerEvent<HTMLInputElement>) {
    // Keep keyboard-oriented text entry on desktop. On touch-sized viewports,
    // a field tap should use the existing native calendar instead of opening
    // the numeric keyboard for a locale-formatted date string.
